...
void GentoRecoMatchingv2(std::string masses, int lifetime){
	...
	std::string fileString = "/nfs/cms/mc1/ama288/EWKino/hats_2020_gen/CMSSW_10_6_12/src/GEN4HATS/genproductions/bin/MadGraph5_aMCatNLO/lxplusData/" + masses + "/reco/mm/" + masses + "_v6_" + a2 + "mm.root";
	...
	std::string outputdir = "~/public_html/EWKino/GentoRecoMatching/" + masses +"/" + a2 + "mm/";
