...
options.register('inputDirectory', '', VarParsing.VarParsing.multiplicity.singleton, VarParsing.VarParsing.varType.string, "Input File Directory")
...
if options.test:
    ...
    if 'cmslpc' in platform.node():
        ...
        sampledir = 'root://eosuser.cern.ch///eos/user/a/alalbert/iDM/Samples/' + options.inputDirectory + '/'
